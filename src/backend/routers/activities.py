...
def get_activities(
    ...
    - difficulty_level: Filter by difficulty ('Beginner', 'Intermediate', 'Advanced', 'all' for unspecified only, or omit to show all activities)
    """
    ...
    if difficulty_level:
        if difficulty_level == "all":
            # "all" means only activities without a specified difficulty level
